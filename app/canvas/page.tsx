...
export const metadata: Metadata = {
  title: "Logic Model Canvas - MUSE by BeaconLabs",
  description: "Interactive canvas for creating evidence-based logic models",
  openGraph: {
    title: "Logic Model Canvas - MUSE by BeaconLabs",
    description: "Interactive canvas for creating evidence-based logic models",
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Logic Model Canvas - MUSE by BeaconLabs",
      },
    ],
  },
  twitter: {
