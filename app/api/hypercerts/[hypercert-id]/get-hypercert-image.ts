...
const PLACEHOLDER_IMAGE_PATH = path.join(process.cwd(), "public", "assets", "media", "images");
...
async function getImageData(imageOrUrl: string): Promise<{ contentType: string; buffer: Buffer }> {
